...
class SpeechGapicClientProto
{
     ...
     *     @type string $transport The transport to be used.
     * }
     * @experimental
     */
    public function __construct(array $options = [])
    {
        $options = $this->configureClient(
            self::SERVICE_NAME,
            __DIR__ . '/../resources/speech_client_descriptors.php',
            $options + [
                ...
                'restClientConfigPath' => __DIR__.'/../resources/speech_rest_client_config.json'
            ]
        );
        // $this->operationsClient = $this->configureOperationsClient($options);
    }
